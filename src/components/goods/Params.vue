<template>
  <div>
          ...
          <el-table :data="manyTableData" border stripe>
            ...
            <el-table-column type="expand">
              <template slot-scope="scope">
                ...
                ></el-input>
                <!-- 添加按钮 -->
                <!-- @click="showInput"点击按钮的时候控制文本框的显示 -->
    ...
    <el-dialog
      ...
      width="50%"
      @close="additDialogClosed"
    >
      <!-- :model="addForm"绑定表单数据对象 -->
